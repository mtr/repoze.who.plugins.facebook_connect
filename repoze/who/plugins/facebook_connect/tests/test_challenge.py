...
class ChallengeTest(unittest.TestCase):
    ...
    def test_challenge_decider(self):
        ...
        self.assertEqual(
            openid_challenge_decider({}, '401 Unauthorized', {}), True)
    ...
    def test_challenge_redirect(self):
        ...
        self.assertEqual(
            res.location, 'http://someopenidprovider.com/somewhere')
    ...
    def test_login_form_send(self):
        ...
        self.assertEqual(environ.get(
            'repoze.whoplugins.openid.openid', None), 'foobar.com')
